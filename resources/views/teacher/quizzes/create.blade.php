            ...
            <form id="addQuestionForm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="question_image" class="form-label">Gambar Pertanyaan (Opsional)</label>
                        ...
                        <!-- Jawaban Benar untuk Jawaban Singkat -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            saveQuestionButton.addEventListener('click', function() {
                ...
                // Validasi
                if (!questionText) {
                    alert('Harap masukkan teks pertanyaan.');
                    return;
                }
                if ((questionType === '0' || questionType === '1') && choices.length === 0) {
                    alert('Harap tambahkan setidaknya satu pilihan jawaban.');
                    return;
                }
                if (questionType === '0' && correctAnswers.length !== 1) {
                    alert('Harap pilih tepat satu jawaban yang benar untuk Pilihan Tunggal.');
                    return;
                }
                if (questionType === '2' && !shortAnswer) {
                    alert('Harap masukkan jawaban yang benar untuk pertanyaan Jawaban Singkat.');
                    return;
                }
                if (!questionPoints || questionPoints < 1) {
                    alert('Harap masukkan poin yang valid untuk pertanyaan.');
                    return;
                }
            ...
            function renderQuestions() {
                questionsContainer.innerHTML = ''; // Hapus pertanyaan yang ada
                ...
                // Perbarui pertanyaan di input tersembunyi
                questionsDataInput.value = JSON.stringify(questions);
            }
            ...
            function editQuestion(index) {
                ...
                // Isi Modal Edit dengan data pertanyaan
